...
%
\cite{Pavlinovic2014-mr,Pavlinovic2015-kh} translate the %error
...
In addition to localizing the error, \cite{Lerner2007-dt} attempt to
...
%
\cite{Chen2014-gd} use a variational type system to allow for the
...
studied extensively.
%
\cite{Marceau2011-ok,Marceau2011-cy} study the effectiveness of error
messages in novice environments and present suggestions for improving
their quality and consistency.
%
\cite{Hage2006-hc} identify a variety of general heuristics to improve
the quality of type error messages, based on their teaching experience.
%
\cite{Heeren2003-db}, \cite{Christiansen2014-qc}, and
\cite{Serrano2016-oo} provide methods for library authors to specialize
...
\cite{Vytiniotis2012-gh} extend the \haskell
...
at runtime.
%
\cite{Bayne2011-cn} also provide a semantics for running

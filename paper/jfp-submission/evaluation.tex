...
%
However, for the impatient reader, we begin with a quick summary of our main results:
...
fast enough to be integrated into the edit-compile-debug cycle.
%
...
Finally, we find that a simple heuristic allows us to use witnesses
...
a small slice of the program that likely contains the error.
%
Using this heuristic, \toolname's witness are competitive with the
state-of-the-art type error localization tools \mycroft and \sherrloc.

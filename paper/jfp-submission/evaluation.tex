...
\caption{Results of our coverage testing and the distribution of test
  outcomes. Our random search successfully finds witnesses for 76--82\% of
  the programs in under one second, improving to 84--85\% in under
...
%
(2) dealing with an explosion in the size of generated traces;
%

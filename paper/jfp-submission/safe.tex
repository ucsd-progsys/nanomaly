...
%
44\% of the samples lack a witness in our
...
\paragraph{Dead Code.}
%
40\% of the samples contained type errors that were unreachable, either
because they were dead code, or because the student called the function
with inputs that could not trigger the error.


12\% of the samples contained type errors that were
...
A further 28\% of the samples included a function call where the
...
%
We found that 16\% of the samples admitted a witness that \toolname

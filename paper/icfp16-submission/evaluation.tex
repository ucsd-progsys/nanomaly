...
\item \emphbf{Jump Metric} The size of the trace for after expanding
  only the forward (or backward) jumps from the witness to the stuck
  term.
\end{enumerate}

...
%
We provide a short-cut to expand the witness to a \emph{jump-compressed}
trace, which contains every function call and return step.
%
...
practical, with an average trace size of 7 nodes and a median of 5.

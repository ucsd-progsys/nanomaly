...
For all traces
$\trace \defeq \triple{\eapp{f}{\vhole{\thole}}}{\emptysu}{\emptysu},\ldots,\triple{e}{\vsu}{\tsu}$,
$\vcompat{\resolve{\ehole}{\vsu}}{\resolve{\thole}{\tsu}}$.
\end{lem}
\begin{proof}
  By induction on $\trace$.
  %
  In the base case $\trace = \triple{\eapp{f}{\vhole{\thole}}}{\emptysu}{\emptysu}$
  and $\vhole{\thole}$ is trivially compatible with $\thole$.
  %
  ...
  $\vcompat{\resolve{\ehole}{\vsu}}{\resolve{\thole}{\tsu}}$, then
  $\vcompat{\resolve{\ehole}{\vsu'}}{\resolve{\thole}{\tsu'}}$.
  %
...
\begin{proof}
  ...
  values differ,
  $\resolve{\vhole{\thole}}{\vsu_{i-1}} = \invctx{\ehole'[\thole']}$
  and
  $\resolve{\vhole{\thole}}{\vsu_{i}} = \invctx{v'}$.
  %
  Furthermore, by Lemma~\ref{lem:resolve-compat} we know that
  $$

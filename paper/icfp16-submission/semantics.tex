...
\begin{cases}
  \triple{v}{\vsu}{\tsu'}    & \mbox{if } v = \lookupsu{\vsu}{\ehole},
                                         \tsu' = \unify{\{t_1, t_2, \typeof{v}\}}{\tsu}\\
  \triple{\stuck}{\vsu}{\tsu} & \mbox{if } v = \lookupsu{\vsu}{\ehole} \\
  \triple{v}{\extendsu{\vsu}{\ehole}{v}}{\tsu'} & \mbox{if}\ \tsu' = \unify{\{t_1, t_2\}}{\tsu}, v = \gen{t_1}{\tsu'}\\
\end{cases} \\
% \begin{cases}
...
\item [Case \tcompat{s}{t}:]
  ...
  $\eapp{f}{v}$ gets stuck. \ES{here we also need a repeated application of the substitution, as \ehole may map directly to $\vnode{\thole}{\vhole{\thole}}{\vleaf{\thole}}{\vleaf{\thole}}$}

...
%
We write \steptr{\trace}{e}{\vsu}{\tsu}{e'}{\vsu'}{\tsu'} if $\trace$ is
a trace of the form $\triple{e}{\vsu}{\tsu},\ldots,\triple{e'}{\vsu'}{\tsu'}$.
%
We write \steps{e}{\vsu}{\tsu}{e'}{\vsu'}{\tsu'} if
\steptr{\trace}{e}{\vsu}{\tsu}{e'}{\vsu'}{\tsu'} for some trace $\trace$.
...
Given these two definitions, we show that each successful evaluation step
...
\begin{lem}
\label{lem:k-stuck}
  If \steptr{\trace}{\eapp{f}{\ehole}}{\emptysu}{\emptysu}{e}{\vsu}{\tsu} and
     \hastype{v}{t} and

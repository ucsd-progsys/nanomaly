...
\begin{proof}[Proof of Lemma~\ref{lem:refine-partial}]
  ...
  \item[Case \renodegood] $v_1$ successfully narrowed to $t$, so it must
    ...
    and $v_3$ successfully narrowed to \ttree{t}, so they must have
    already been \ttree{t}'s or unconstrained holes. Thus partial type
    compatibility of the input is preserved. \ES{return to this}

...
\caption{A selection of the operational semantics from
  ...
  % WRW: \subterms is Used here in the figure before being Defined (indeed,
  % it is never defined anywhere that I can see). A simple bit in text to
  % explain what you mean would help. Why is subterms necessary? What does
  % it collect up for you? 
  graph.}
...
% WRW: This was "e_1 steps, in a single step" which was circular.

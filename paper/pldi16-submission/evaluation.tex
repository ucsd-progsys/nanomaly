...
\caption{Results of our coverage testing and the distribution of test
  % WRW notes that the pie chart does not print on standard department
  % printer, and is emailing a photo as proof. Possible solution:
  % convert PDF -> PNG and include PNG? 
...
pairs.
% WRW: Say more here. This is critical to your evaluatino and to your
% conclusion (e.g., where we say that jump-compressed traces hide boring
% details). Why are these details boring and others relevant? Do the
% boring ones contain less information somehow? 
%

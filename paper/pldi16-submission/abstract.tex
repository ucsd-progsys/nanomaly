\begin{abstract}
  ...
  %
  Second, we prove that our procedure synthesizes
  ...
  %
  Third, we show how to extend the above procedure to
  produce a \emph{reduction graph} that can be used to
  interactively visualize and debug witness executions.
  %
  Fourth, we evaluate our approach on two data sets
  comprising more than 5000 ill-typed student programs.
  Our technique is able to generate witnesses for
  nearly 90\% of the programs, and our reduction graph

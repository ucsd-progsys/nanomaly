...
\end{lem}
\begin{proof}
  By case analysis on the evaluation rules. If 
  $\ptype{k}{f} \neq \ptype{k+1}{f}$ then one of the holes in 
  $f$'s argument must have been instantiated with a concrete value at step $k+1$.

...
% WRW is still minorly worried about this theorem as phrased (cf. every
% inhabitable type). Perhaps jsut a footnote explaining why \alpha -> \beta
...
% WRW: Just to be sure, the type of "lambda x. x + 1" would seem
% to be box_1 -> box_2 here, while one might be tempted to get
% int -> int. Some extra prose text contrasting typeof() with
% "apply f to box to get a partial type" would likely help. 

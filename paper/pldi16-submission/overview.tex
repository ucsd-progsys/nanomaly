...
Consider the @fac@ function from Figure~\ref{fig:factorial},
reproduced here.
...
We show in \S~\ref{sec:soundness} our lazy instantiation of holes
...
\S~\ref{sec:explaining} --- to insert another term into the
visualization.

...
Thus, \toolname's witnesses can be viewed as \emph{counterexamples},
thereby connecting it to work on using test generation to find
counterexamples prior to starting a proof proof~\cite{ACL2Testing, Seidel15}.
...
\cite{Flanagan96} describes a static debugger for Scheme, which helps
the programmer interactively visualize problematic source-sink flows
corresponding soft-typing errors. The debugger allows the user to explore
